...
Usage:
    julia --project=. src/function_learning/generate_tables.jl <stats.json>
    julia --project=. src/function_learning/generate_tables.jl <stats.json> --output tables.tex
    julia --project=. src/function_learning/generate_tables.jl <stats.json> --stdout
    julia --project=. src/function_learning/generate_tables.jl <stats.json> --verbose
"""

...
Usage:
    julia --project=. src/polynomial_solving/generate_tables.jl <stats.json>
    julia --project=. src/polynomial_solving/generate_tables.jl <stats.json> --output tables.tex
    julia --project=. src/polynomial_solving/generate_tables.jl <stats.json> --stdout
    julia --project=. src/polynomial_solving/generate_tables.jl <stats.json> --verbose
"""

...
Usage:
    julia --project=. src/absolute_sum_minimization/run_experiments.jl [FLAGS]
...
Examples:
    ...
    julia --project=. src/absolute_sum_minimization/run_experiments.jl --paper --save
"""
...
if args.save_results
    ...
    output_path = if isnothing(args.output_filename)
        ...
        joinpath(logs_dir, "absolute_sum_minimization_$(ts).json")
    else

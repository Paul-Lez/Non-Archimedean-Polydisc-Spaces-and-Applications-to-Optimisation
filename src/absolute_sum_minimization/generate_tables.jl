...
Usage:
    julia --project=. src/absolute_sum_minimization/generate_tables.jl <stats.json>
    julia --project=. src/absolute_sum_minimization/generate_tables.jl <stats.json> --output tables.tex
    julia --project=. src/absolute_sum_minimization/generate_tables.jl <stats.json> --stdout
    julia --project=. src/absolute_sum_minimization/generate_tables.jl <stats.json> --verbose
"""
